...
export default function Friends() {
  ...
  const handleCopyInviteLink = useCallback(() => {
    triggerHapticFeedback(window);
    navigator.clipboard
      .writeText(process.env.NEXT_PUBLIC_BOT_USERNAME ? `https://t.me/${process.env.NEXT_PUBLIC_BOT_USERNAME}/${process.env.NEXT_PUBLIC_APP_URL_SHORT_NAME}?startapp=kentId${getUserTelegramId(userTelegramInitData) || ""}` : "https://t.me/")
      .then(() => {
  ...
  const handleInviteFriend = useCallback(() => {
    ...
    const shareText = `🎮 Join me in FrostBite: Tap, Earn, and Win! 🏆\n🚀 Let's play and earn together!`;
